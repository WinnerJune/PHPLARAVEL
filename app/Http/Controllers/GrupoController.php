...
class GrupoController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('grupos.index')->with('seccess', 'Grupo actualizado correctamente.');
    }
    ...
    public function destroy($id)
    {
        ...
        $grupo->delete();
        return redirect()->route('grupos.index')->with('seccess','Grupo eiminado correctamente.');
    }
}
